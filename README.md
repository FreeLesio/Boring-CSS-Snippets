...
1 - Slightly rotates the screen
2 - Change all fonts for "Comic Sans MS"
3 - Change links colors to pink
4 - Change all the colors of the site in a loop
5 - Make all colors grayscale
6 - Shake the page
7 - Replace the default cursor by a waiting cursor
...
1 - Fait légèrement pivoter l'écran
2 - Changer toutes les polices pour "Comic Sans MS"
3 - Changer les couleurs des liens en rose
4 - Changer toutes les couleurs du site en boucle
5 - Rendre toutes les couleurs en niveaux de gris
6 - Secouez la page
7 - Remplacer le curseur par défaut par un curseur en attente
